...
export default function Tema4() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h1 className="text-3xl font-bold text-green-600 mb-2">Tema 4: Colours & Days</h1>
      <div className="flex items-center justify-between mb-4">
        <div className="font-bold text-green-700 text-base">Puntaje: {puntaje} / {actividades.length}</div>
        <button
