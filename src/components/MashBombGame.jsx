...
const preguntas = [
  ...
  { pregunta: 'El uniforme de Aoi es de color…', opciones: ['White and Brown', 'White and Yellow', 'White and Green', 'White and Blue'], correcta: 3 },
  ...
  { pregunta: 'What is "twelve" in Spanish?', opciones: ['Once', 'Diez', 'Doce', 'Trece'], correcta: 2 },
  ...
  { pregunta: 'How do you say "once" in English?', opciones: ['Nine', 'Twelve', 'One', 'Eleven'], correcta: 3 },
  { pregunta: 'El número 25 en inglés es…', opciones: ['Twenty-five', 'Twenty-four', 'Fifty-two', 'Thirty-five'], correcta: 0 },
  { pregunta: '"Ninety" en español significa…', opciones: ['Nueve', 'Diecinueve', 'Noventa', 'Noveno'], correcta: 2 },

  // 📅 DAYS OF THE WEEK
  { pregunta: 'What day comes after Monday?', opciones: ['Sunday', 'Tuesday', 'Friday', 'Thursday'], correcta: 1 },
  { pregunta: '"Miércoles" en inglés es…', opciones: ['Friday', 'Monday', 'Thursday', 'Wednesday'], correcta: 3 },
  { pregunta: 'How do you say "sábado" in English?', opciones: ['Saturday', 'Sunday', 'Thursday', 'Tuesday'], correcta: 0 },
  { pregunta: 'The first day of the week in English calendars is…', opciones: ['Friday', 'Monday', 'Sunday', 'Saturday'], correcta: 2 },
  ...
  { pregunta: 'How do you say "martes" in English?', opciones: ['Thursday', 'Wednesday', 'Tuesday', 'Friday'], correcta: 2 },
  { pregunta: '¿Cuál es el día "Friday" en español?', opciones: ['Domingo', 'Lunes', 'Miércoles', 'Viernes'], correcta: 3 },
  ...
  { pregunta: '"Francia" en inglés es…', opciones: ['French', 'Frank', 'France', 'Francy'], correcta: 2 },
  { pregunta: 'Tokyo is a city in…', opciones: ['Brazil', 'Japan', 'Italy', 'USA'], correcta: 1 },
  { pregunta: '"Argentina" en inglés se escribe…', opciones: ['Argentine', 'Arjentina', 'Argentinian', 'Argentina'], correcta: 3 },
  ...
  { pregunta: '"Reino Unido" en inglés se dice…', opciones: ['United City', 'United States', 'United Kingdom', 'United Empire'], correcta: 2 },
  { pregunta: 'Paris es la capital de…', opciones: ['France', 'Italy', 'England', 'Germany'], correcta: 0 },
  { pregunta: 'The Statue of Liberty is in…', opciones: ['London', 'New York', 'Tokyo', 'Rome'], correcta: 1 },

  // 🎓 NATIONALITIES
  { pregunta: 'Someone from Brazil is…', opciones: ['Brazilian', 'Brazilish', 'Braziler', 'Brazilite'], correcta: 0 },
  { pregunta: '"Argentinian" en español es…', opciones: ['Chileno', 'Brasileño', 'Argentino', 'Peruano'], correcta: 2 },
  { pregunta: 'People from Japan are…', opciones: ['Japanish', 'Japanese', 'Japanite', 'Japonic'], correcta: 1 },
  { pregunta: '"French" es la nacionalidad de…', opciones: ['Brasil', 'Perú', 'Italia', 'Francia'], correcta: 3 },
  ...
  { pregunta: 'A person from Peru is…', opciones: ['Perunian', 'Peruan', 'Peruvian', 'Perulian'], correcta: 2 },
  ...
  { pregunta: '"Nice to meet you" significa…', opciones: ['Hasta luego', 'Buenos días', 'Encantado de conocerte', 'Por favor'], correcta: 2 },
  { pregunta: 'Complete: "_ _ _ _ _ your name?"', opciones: ['Where', 'What\'s', 'Who', 'How'], correcta: 1 },
  { pregunta: 'La respuesta correcta a "How are you?" es…', opciones: ['Sunday', 'Blue', 'England', 'I\'m fine, thanks'], correcta: 3 },
  { pregunta: 'Mash dice: "Hi! ____ Mash."', opciones: ['I\'m', 'Is', 'Are', 'Be'], correcta: 0 },
  { pregunta: '"Goodbye" en español es…', opciones: ['Gracias', 'Hola', 'Adiós', 'Perdón'], correcta: 2 },
  { pregunta: 'Complete: "Nice ____ meet you."', opciones: ['for', 'to', 'at', 'in'], correcta: 1 },
  ...
  { pregunta: '"Good morning" se usa para saludar en…', opciones: ['todo el día', 'la noche', 'la tarde', 'la mañana'], correcta: 3 },
  ...
  { pregunta: 'Complete: "My birthday is ___ February 27th."', opciones: ['of', 'in', 'at', 'on'], correcta: 3 },
  ...
  { pregunta: 'Sofía dice: "I like ______."', opciones: ['crazy', 'Monday', 'pizza', 'England'], correcta: 2 },
  { pregunta: '¿Cómo se dice "Escuela" en inglés?', opciones: ['Scool', 'School', 'Scul', 'Skool'], correcta: 1 },
  { pregunta: 'Complete: "He is ____ years old."', opciones: ['fifthteen', 'fifteenth', 'fifteen', 'fiveteen'], correcta: 2 },
  { pregunta: '"My favourite subject is English" significa…', opciones: ['Mi materia favorita es frances', 'Mi materia favorita es inglés', 'No me gusta inglés', 'Mi profesor favorito es inglés'], correcta: 1 },
  ...
  { pregunta: 'Complete: "She ____ 11 years old."', opciones: ['are', 'is', 'am', 'be'], correcta: 1 },

  // 💬 TO BE & PRONOUNS
  { pregunta: 'Pronoun for "Agustina y yo" is…', opciones: ['She', 'They', 'We', 'He'], correcta: 2 },
  { pregunta: '"He is" en forma corta es…', opciones: ['He\'s', 'Hes', 'H\'s', 'He is'], correcta: 0 },
  { pregunta: 'Choose the correct form: "They ___ friends."', opciones: ['be', 'is', 'am', 'are'], correcta: 3 },
  { pregunta: '"Yo" en inglés es…', opciones: ['You', 'I', 'He', 'She'], correcta: 1 },
  { pregunta: 'Negative form: "She is not" →', opciones: ['She isn\'t', 'She aren\'t', 'She amn\'t', 'She not'], correcta: 0 },
  { pregunta: '"It" se usa para…', opciones: ['Femenino plural', 'Masculino plural', 'Objetos o animales', 'Personas en plural'], correcta: 2 },
  { pregunta: 'Complete: "We ___ from France."', opciones: ['be', 'is', 'am', 'are'], correcta: 3 },
  { pregunta: 'Choose the pronoun for "Harry y Ron."', opciones: ['We', 'They', 'He', 'She'], correcta: 1 },
  { pregunta: 'Form the question: "_ _ _ Mash 15?"', opciones: ['Am', 'Are', 'Is', 'Be'], correcta: 2 },
  { pregunta: 'Short answer: "Are you ready?" – "___, I am."', opciones: ['Yes', 'No', 'Good', 'OK'], correcta: 0 },

  // 🔄 MIXED REVIEW & MICRO-STORY
  { pregunta: 'Fill the blank: "_ _ _ _ _ to meet you, I\'m Hanako."', opciones: ['Nine', 'Blue', 'France', 'Nice'], correcta: 3 },
  { pregunta: '"Blue and ______ are primary colours."', opciones: ['Brown', 'Grey', 'Red', 'Pink'], correcta: 2 },
  { pregunta: 'Which day is the fifth of the English week?', opciones: ['Tuesday', 'Thursday', 'Sunday', 'Saturday'], correcta: 1 },
  { pregunta: 'Number "60" in English is…', opciones: ['Sixty', 'Sixteen', 'Six', 'Seventy'], correcta: 0 },
  { pregunta: 'Nationality of someone from Italy:', opciones: ['Italen', 'Italish', 'Italic', 'Italian'], correcta: 3 },
  { pregunta: 'Greeting for the evening:', opciones: ['Hello', 'Good morning', 'Good evening', 'See you'], correcta: 2 },
  { pregunta: 'Colour of Gryffindor scarf (one of them):', opciones: ['Green', 'Red', 'Blue', 'Yellow'], correcta: 1 },
  { pregunta: '"¿Cuántos años tienes?" en inglés es…', opciones: ['How old are you?', 'Where are you?', 'What are you?', 'Who are you?'], correcta: 0 },
  { pregunta: 'Capital city of France is…', opciones: ['Berlin', 'Santiago del Estero', 'London', 'Paris'], correcta: 3 },
  { pregunta: 'Complete: "Hanako ____ from Japan."', opciones: ['am', 'are', 'is', 'be'], correcta: 2 }
];
